...
*/
var tensorFromPinnedBuffer = (type, buffer, dims) => new Tensor$1({
	location: "cpu-pinned",
	type,
	data: buffer,
...
var InferenceSession = class InferenceSession$1 {
	constructor(handler) {
...
//#endregion
//#region node_modules/onnxruntime-common/dist/esm/index.js
...
//#endregion
export { TRACE_FUNC_END as a, registerBackend as c, TRACE_FUNC_BEGIN as i, InferenceSession as n, Tensor as o, TRACE as r, env as s, esm_exports as t };
